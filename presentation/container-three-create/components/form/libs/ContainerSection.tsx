...
const ContainerSearchField = () => {
  const setHourInit = useWorkflowStoreThreeZero((state) => state.setHourInit);
  ...
  const setClientId = useWorkflowStoreThreeZero((state) => state.setClientId);
  const setClientIdentification = useWorkflowStoreThreeZero(
...
const ClientInfo = () => {
  ...
  const clientIdentification = useWorkflowStoreThreeZero(
