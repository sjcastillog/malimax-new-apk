...
const LabelSerial = () => {
  const labelSerial = useWorkflowStoreThreeZero((state) => state.labelSerial);
  const setLabelSerial = useWorkflowStoreThreeZero(
...
const ContainerOpened = () => {
  const openedWas = useWorkflowStoreThreeZero((state) => state.openedWas);
  const setOpenedWas = useWorkflowStoreThreeZero((state) => state.setOpenedWas);
  const openedBy = useWorkflowStoreThreeZero((state) => state.openedBy);
  const setOpenedBy = useWorkflowStoreThreeZero((state) => state.setOpenedBy);
...
const NavieraTypeSize = () => {
  const naviera = useWorkflowStoreThreeZero((state) => state.naviera);
  const setNaviera = useWorkflowStoreThreeZero((state) => state.setNaviera);
  const typeContainer = useWorkflowStoreThreeZero((state) => state.typeContainer);
  const setTypeContainer = useWorkflowStoreThreeZero(
    (state) => state.setTypeContainer,
  );
  const size = useWorkflowStoreThreeZero((state) => state.size);
  const setSize = useWorkflowStoreThreeZero((state) => state.setSize);
...
const LocationDetails = () => {
  const city = useWorkflowStoreThreeZero((state) => state.city);
  const setCity = useWorkflowStoreThreeZero((state) => state.setCity);
  const address = useWorkflowStoreThreeZero((state) => state.address);
  const setAddress = useWorkflowStoreThreeZero((state) => state.setAddress);
  const typeReview = useWorkflowStoreThreeZero((state) => state.typeReview);
  const setTypeReview = useWorkflowStoreThreeZero((state) => state.setTypeReview);
  const storageName = useWorkflowStoreThreeZero((state) => state.storageName);
  const setStorageName = useWorkflowStoreThreeZero(
