...
export const InspectionSection = () => {
  const inspectedWas = useWorkflowStoreOneZero((state) => state.inspectedWas);
  const setInspectedWas = useWorkflowStoreOneZero(
    (state) => state.setInspectedWas,
  );
  const inspectedBy = useWorkflowStoreOneZero((state) => state.inspectedBy);
  const setInspectedBy = useWorkflowStoreOneZero(
