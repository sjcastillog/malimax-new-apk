...
const LabelSerial = () => {
  const labelSerial = useWorkflowStoreTwoZero((state) => state.labelSerial);
  const setLabelSerial = useWorkflowStoreTwoZero(
...
const ContainerOpened = () => {
  const openedWas = useWorkflowStoreTwoZero((state) => state.openedWas);
  const setOpenedWas = useWorkflowStoreTwoZero((state) => state.setOpenedWas);
  const openedBy = useWorkflowStoreTwoZero((state) => state.openedBy);
  const setOpenedBy = useWorkflowStoreTwoZero((state) => state.setOpenedBy);
...
const NavieraTypeSize = () => {
  const naviera = useWorkflowStoreTwoZero((state) => state.naviera);
  const setNaviera = useWorkflowStoreTwoZero((state) => state.setNaviera);
  const typeContainer = useWorkflowStoreTwoZero((state) => state.typeContainer);
  const setTypeContainer = useWorkflowStoreTwoZero(
    (state) => state.setTypeContainer,
  );
  const size = useWorkflowStoreTwoZero((state) => state.size);
...
const LocationDetails = () => {
  const city = useWorkflowStoreTwoZero((state) => state.city);
  const setCity = useWorkflowStoreTwoZero((state) => state.setCity);
  const address = useWorkflowStoreTwoZero((state) => state.address);
  const setAddress = useWorkflowStoreTwoZero((state) => state.setAddress);
  const typeReview = useWorkflowStoreTwoZero((state) => state.typeReview);
  const setTypeReview = useWorkflowStoreTwoZero((state) => state.setTypeReview);
  const storageName = useWorkflowStoreTwoZero((state) => state.storageName);
  const setStorageName = useWorkflowStoreTwoZero(
    (state) => state.setStorageName,
  );
  const entryPort = useWorkflowStoreTwoZero((state) => state.entryPort);
