...
export const SaveButton = () => {
  ...
  const storeState = useWorkflowStoreTwoExtraThree((state) => state) as any;
  const onClearNext = useWorkflowStoreTwoExtraThree((state) => state.onClear);
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            onClearNext();
            router.replace("/(drawer)/(stack)/container-three/extra-three");
          },
          style: "default",
        },
        {
