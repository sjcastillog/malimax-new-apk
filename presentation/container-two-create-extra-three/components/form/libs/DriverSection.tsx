...
export const DriverSection = () => {
  const driverName = useWorkflowStoreTwoExtraThree((state) => state.driverName);
  const setDriverName = useWorkflowStoreTwoExtraThree((state) => state.setDriverName);
  const driverIdentification = useWorkflowStoreTwoExtraThree(
  ...
  const plateVehicle = useWorkflowStoreTwoExtraThree((state) => state.plateVehicle);
  const setPlateVehicle = useWorkflowStoreTwoExtraThree(
    (state) => state.setPlateVehicle,
  );
  const companyTransport = useWorkflowStoreTwoExtraThree(
