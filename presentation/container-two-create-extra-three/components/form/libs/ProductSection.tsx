...
const ProductField = () => {
  const product = useWorkflowStoreTwoExtraThree((state) => state.product);
  const setProduct = useWorkflowStoreTwoExtraThree((state) => state.setProduct);
...
const PresentationField = () => {
  const presentation = useWorkflowStoreTwoExtraThree((state) => state.presentation);
  const setPresentation = useWorkflowStoreTwoExtraThree(
