...
const LabelSerial = () => {
  const labelSerial = useWorkflowStoreTwoExtraThree((state) => state.labelSerial);
  const setLabelSerial = useWorkflowStoreTwoExtraThree(
...
const ContainerOpened = () => {
  const openedWas = useWorkflowStoreTwoExtraThree((state) => state.openedWas);
  const setOpenedWas = useWorkflowStoreTwoExtraThree((state) => state.setOpenedWas);
  const openedBy = useWorkflowStoreTwoExtraThree((state) => state.openedBy);
  const setOpenedBy = useWorkflowStoreTwoExtraThree((state) => state.setOpenedBy);
...
const NavieraTypeSize = () => {
  const naviera = useWorkflowStoreTwoExtraThree((state) => state.naviera);
  const setNaviera = useWorkflowStoreTwoExtraThree((state) => state.setNaviera);
  const typeContainer = useWorkflowStoreTwoExtraThree((state) => state.typeContainer);
  const setTypeContainer = useWorkflowStoreTwoExtraThree(
    (state) => state.setTypeContainer,
  );
  const size = useWorkflowStoreTwoExtraThree((state) => state.size);
...
const LocationDetails = () => {
  const city = useWorkflowStoreTwoExtraThree((state) => state.city);
  const setCity = useWorkflowStoreTwoExtraThree((state) => state.setCity);
  const address = useWorkflowStoreTwoExtraThree((state) => state.address);
  const setAddress = useWorkflowStoreTwoExtraThree((state) => state.setAddress);
  const typeReview = useWorkflowStoreTwoExtraThree((state) => state.typeReview);
  const setTypeReview = useWorkflowStoreTwoExtraThree((state) => state.setTypeReview);
  const storageName = useWorkflowStoreTwoExtraThree((state) => state.storageName);
  const setStorageName = useWorkflowStoreTwoExtraThree(
    (state) => state.setStorageName,
  );
  const entryPort = useWorkflowStoreTwoExtraThree((state) => state.entryPort);
