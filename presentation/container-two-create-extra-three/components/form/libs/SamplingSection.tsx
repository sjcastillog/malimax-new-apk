...
const NumberPalletField = () => {
  const numberPallet = useWorkflowStoreTwoExtraThree((state) => state.numberPallet);
  const setNumberPallet = useWorkflowStoreTwoExtraThree(
...
const NumberPresentationField = () => {
  const numberPresentation = useWorkflowStoreTwoExtraThree(
    (state) => state.numberPresentation,
  );
  const setNumberPresentation = useWorkflowStoreTwoExtraThree(
...
const NumberSamplingField = () => {
  const numberSampling = useWorkflowStoreTwoExtraThree(
    (state) => state.numberSampling,
  );
  const setNumberSampling = useWorkflowStoreTwoExtraThree(
