...
export const ContainerSection = () => {
  const container = useWorkflowStoreTwoExtraThree((state) => state.container);
  const setContainer = useWorkflowStoreTwoExtraThree((state) => state.setContainer);
  const startProcess = useWorkflowStoreTwoExtraThree((state) => state.startProcess);
  const setStartProcess = useWorkflowStoreTwoExtraThree(
    (state) => state.setStartProcess,
  );
  const client = useWorkflowStoreTwoExtraThree((state) => state.client);
  const setClient = useWorkflowStoreTwoExtraThree((state) => state.setClient);

  // Setters para cargar datos del proceso ONE
  const setCity = useWorkflowStoreTwoExtraThree((state) => state.setCity);
  const setAddress = useWorkflowStoreTwoExtraThree((state) => state.setAddress);
  const setTypeReview = useWorkflowStoreTwoExtraThree((state) => state.setTypeReview);
  const setStorageName = useWorkflowStoreTwoExtraThree(
    (state) => state.setStorageName,
  );
  const setDriverName = useWorkflowStoreTwoExtraThree((state) => state.setDriverName);
  const setDriverIdentification = useWorkflowStoreTwoExtraThree(
    (state) => state.setDriverIdentification,
  );
  const setPlateVehicle = useWorkflowStoreTwoExtraThree(
    (state) => state.setPlateVehicle,
  );
  const setCompanyTransport = useWorkflowStoreTwoExtraThree(
    (state) => state.setCompanyTransport,
  );
  const setNaviera = useWorkflowStoreTwoExtraThree((state) => state.setNaviera);
  const setTypeContainer = useWorkflowStoreTwoExtraThree(
    (state) => state.setTypeContainer,
  );
  const setSize = useWorkflowStoreTwoExtraThree((state) => state.setSize);
  const setEntryPort = useWorkflowStoreTwoExtraThree((state) => state.setEntryPort);

  // Setters para fotos de validación
  const setEmptyPanoramicValidationPhoto = useWorkflowStoreTwoExtraThree(
    (state) => state.setEmptyPanoramicValidationPhoto,
  );
  const setEmptyStampNavieraValidationPhoto = useWorkflowStoreTwoExtraThree(
    (state) => state.setEmptyStampNavieraValidationPhoto,
  );
  const setEmptyOtherStampValidationPhoto = useWorkflowStoreTwoExtraThree(
    (state) => state.setEmptyOtherStampValidationPhoto,
  );
  const setEmptySatelliteLockValidationPhoto = useWorkflowStoreTwoExtraThree(
    (state) => state.setEmptySatelliteLockValidationPhoto,
  );
  const setExitEngineryValidationPhoto1 = useWorkflowStoreTwoExtraThree(
    (state) => state.setExitEngineryValidationPhoto1,
  );
  const setExitEngineryValidationPhoto2 = useWorkflowStoreTwoExtraThree(
    (state) => state.setExitEngineryValidationPhoto2,
  );
  const setExitDoorValidationVideo = useWorkflowStoreTwoExtraThree(
    (state) => state.setExitDoorValidationVideo,
  );
  const setExitEngineryValidationVideo = useWorkflowStoreTwoExtraThree(
