...
const LabelSerial = () => {
  const labelSerial = useWorkflowStoreOneExtraTwo((state) => state.labelSerial);
  const setLabelSerial = useWorkflowStoreOneExtraTwo(
...
const ContainerOpened = () => {
  const openedWas = useWorkflowStoreOneExtraTwo((state) => state.openedWas);
  const setOpenedWas = useWorkflowStoreOneExtraTwo((state) => state.setOpenedWas);
  const openedBy = useWorkflowStoreOneExtraTwo((state) => state.openedBy);
  const setOpenedBy = useWorkflowStoreOneExtraTwo((state) => state.setOpenedBy);
...
const NavieraTypeSize = () => {
  const naviera = useWorkflowStoreOneExtraTwo((state) => state.naviera);
  const setNaviera = useWorkflowStoreOneExtraTwo((state) => state.setNaviera);
  const typeContainer = useWorkflowStoreOneExtraTwo((state) => state.typeContainer);
  const setTypeContainer = useWorkflowStoreOneExtraTwo(
    (state) => state.setTypeContainer,
  );
  const size = useWorkflowStoreOneExtraTwo((state) => state.size);
  const setSize = useWorkflowStoreOneExtraTwo((state) => state.setSize);
...
const LocationDetails = () => {
  ...
  const typeReview = useWorkflowStoreOneExtraTwo((state) => state.typeReview);
  const setTypeReview = useWorkflowStoreOneExtraTwo((state) => state.setTypeReview);
  ...
  const entryPort = useWorkflowStoreOneExtraTwo((state) => state.entryPort);
  const setEntryPort = useWorkflowStoreOneExtraTwo((state) => state.setEntryPort);
