...
const CanSelector = () => {
  ...
  const can = useWorkflowStoreOneExtraTwo((state) => state.can);
  const setCan = useWorkflowStoreOneExtraTwo((state) => state.setCan);
...
const LeaderSelector = () => {
  ...
  const leader = useWorkflowStoreOneExtraTwo((state) => state.leader);
  const setLeader = useWorkflowStoreOneExtraTwo((state) => state.setLeader);
  const [showModal, setShowModal] = useState(false);
