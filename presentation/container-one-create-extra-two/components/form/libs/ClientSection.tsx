...
export const ClientSection = () => {
  ...
  const clientIdentification = useWorkflowStoreOneExtraTwo(
    (state) => state.clientIdentification,
  );
  const setClient = useWorkflowStoreOneExtraTwo((state) => state.setClient);
  const setClientId = useWorkflowStoreOneExtraTwo((state) => state.setClientId);
  const setClientIdentification = useWorkflowStoreOneExtraTwo(
