...
export const InspectionSection = () => {
  const inspectedWas = useWorkflowStoreOneExtraTwo((state) => state.inspectedWas);
  const setInspectedWas = useWorkflowStoreOneExtraTwo(
    (state) => state.setInspectedWas,
  );
  const inspectedBy = useWorkflowStoreOneExtraTwo((state) => state.inspectedBy);
  const setInspectedBy = useWorkflowStoreOneExtraTwo(
