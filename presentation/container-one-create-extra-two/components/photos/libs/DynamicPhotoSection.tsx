...
export const DynamicPhotosSection = () => {
  const { images, addImage, removeImage } = useWorkflowStoreOneExtraTwo();
  ...
  const additionalImages = images.filter((img) => img.type === "aditional");

  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerText}>➕ FOTOS ADICIONALES</Text>
      </View>
      ...
      <View style={styles.photosList}>
        ...
        <TouchableOpacity style={styles.addButton} onPress={handleAddImage}>
          <Text style={styles.addButtonText}>+ Agregar Foto Adicional</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
const DynamicPhotoItem: React.FC<DynamicPhotoItemProps> = ({
  ...
  const updateImage = useWorkflowStoreOneExtraTwo((state) => state.updateImage);
  ...
  return (
    <View style={styles.photoItem}>
      <View style={styles.photoItemHeader}>
        <Text style={styles.photoItemLabel}>ADICIONAL {index + 1}</Text>
