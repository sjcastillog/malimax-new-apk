...
export const SaveButton = () => {
  ...
  const storeState = useWorkflowStoreOneExtraTwo((state) => state) as any;
  const onClearNext = useWorkflowStoreOneExtraTwo((state) => state.onClear);
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            onClearNext();
            router.push("/container-two/extra-two");
          },
          style: "default",
        },
        {
