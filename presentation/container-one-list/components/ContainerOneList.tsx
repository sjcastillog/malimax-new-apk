...
import { ContainerOneListCard } from "./ContainerOneListCard";
...
const ContainerOneList = ({
  ...
  return (
    <FlatList
      ...
      renderItem={({ item }) => (
        <ContainerOneListCard container={item} dark={dark} />
      )}
...
export default ContainerOneList;
