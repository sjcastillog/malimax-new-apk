...
export const SaveButton = () => {
  ...
  const storeState = useWorkflowStoreTwoExtraOne((state) => state) as any;
  const onClearNext = useWorkflowStoreTwoExtraOne((state) => state.onClear);
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            onClearNext();
            router.replace("/(drawer)/(stack)/container-three/extra-one");
          },
          style: "default",
        },
        {
