...
const ProductField = () => {
  const product = useWorkflowStoreTwoExtraOne((state) => state.product);
  const setProduct = useWorkflowStoreTwoExtraOne((state) => state.setProduct);
...
const PresentationField = () => {
  const presentation = useWorkflowStoreTwoExtraOne((state) => state.presentation);
  const setPresentation = useWorkflowStoreTwoExtraOne(
