...
export const ObservationSection = () => {
  const observation = useWorkflowStoreTwoExtraOne((state) => state.observation);
  const setObservation = useWorkflowStoreTwoExtraOne(
    ...
    <>
      ...
      <View style={styles.formGroup}>
        ...
        <TextInput
          ...
          placeholder="Escribe aquí cualquier observación sobre el proceso de llenado..."
