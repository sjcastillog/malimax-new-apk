...
const LabelSerial = () => {
  const labelSerial = useWorkflowStoreTwoExtraOne((state) => state.labelSerial);
  const setLabelSerial = useWorkflowStoreTwoExtraOne(
...
const ContainerOpened = () => {
  const openedWas = useWorkflowStoreTwoExtraOne((state) => state.openedWas);
  const setOpenedWas = useWorkflowStoreTwoExtraOne((state) => state.setOpenedWas);
  const openedBy = useWorkflowStoreTwoExtraOne((state) => state.openedBy);
  const setOpenedBy = useWorkflowStoreTwoExtraOne((state) => state.setOpenedBy);
...
const NavieraTypeSize = () => {
  const naviera = useWorkflowStoreTwoExtraOne((state) => state.naviera);
  const setNaviera = useWorkflowStoreTwoExtraOne((state) => state.setNaviera);
  const typeContainer = useWorkflowStoreTwoExtraOne((state) => state.typeContainer);
  const setTypeContainer = useWorkflowStoreTwoExtraOne(
    (state) => state.setTypeContainer,
  );
  const size = useWorkflowStoreTwoExtraOne((state) => state.size);
  const setSize = useWorkflowStoreTwoExtraOne((state) => state.setSize);
...
const LocationDetails = () => {
  const city = useWorkflowStoreTwoExtraOne((state) => state.city);
  const setCity = useWorkflowStoreTwoExtraOne((state) => state.setCity);
  const address = useWorkflowStoreTwoExtraOne((state) => state.address);
  const setAddress = useWorkflowStoreTwoExtraOne((state) => state.setAddress);
  const typeReview = useWorkflowStoreTwoExtraOne((state) => state.typeReview);
  const setTypeReview = useWorkflowStoreTwoExtraOne((state) => state.setTypeReview);
  const storageName = useWorkflowStoreTwoExtraOne((state) => state.storageName);
  const setStorageName = useWorkflowStoreTwoExtraOne(
    (state) => state.setStorageName,
  );
  const entryPort = useWorkflowStoreTwoExtraOne((state) => state.entryPort);
  const setEntryPort = useWorkflowStoreTwoExtraOne((state) => state.setEntryPort);
