...
const NumberPalletField = () => {
  const numberPallet = useWorkflowStoreTwoExtraOne((state) => state.numberPallet);
  const setNumberPallet = useWorkflowStoreTwoExtraOne(
...
const NumberPresentationField = () => {
  const numberPresentation = useWorkflowStoreTwoExtraOne(
    (state) => state.numberPresentation,
  );
  const setNumberPresentation = useWorkflowStoreTwoExtraOne(
...
const NumberSamplingField = () => {
  const numberSampling = useWorkflowStoreTwoExtraOne(
    (state) => state.numberSampling,
  );
  const setNumberSampling = useWorkflowStoreTwoExtraOne(
