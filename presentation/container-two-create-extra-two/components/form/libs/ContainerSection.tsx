...
export const ContainerSection = () => {
  const container = useWorkflowStoreTwoExtraTwo((state) => state.container);
  const setContainer = useWorkflowStoreTwoExtraTwo((state) => state.setContainer);
  const startProcess = useWorkflowStoreTwoExtraTwo((state) => state.startProcess);
  const setStartProcess = useWorkflowStoreTwoExtraTwo(
    (state) => state.setStartProcess,
  );
  const client = useWorkflowStoreTwoExtraTwo((state) => state.client);
  const setClient = useWorkflowStoreTwoExtraTwo((state) => state.setClient);

  // Setters para cargar datos del proceso ONE
  const setCity = useWorkflowStoreTwoExtraTwo((state) => state.setCity);
  const setAddress = useWorkflowStoreTwoExtraTwo((state) => state.setAddress);
  const setTypeReview = useWorkflowStoreTwoExtraTwo((state) => state.setTypeReview);
  const setStorageName = useWorkflowStoreTwoExtraTwo(
    (state) => state.setStorageName,
  );
  const setDriverName = useWorkflowStoreTwoExtraTwo((state) => state.setDriverName);
  const setDriverIdentification = useWorkflowStoreTwoExtraTwo(
    (state) => state.setDriverIdentification,
  );
  const setPlateVehicle = useWorkflowStoreTwoExtraTwo(
    (state) => state.setPlateVehicle,
  );
  const setCompanyTransport = useWorkflowStoreTwoExtraTwo(
    (state) => state.setCompanyTransport,
  );
  const setNaviera = useWorkflowStoreTwoExtraTwo((state) => state.setNaviera);
  const setTypeContainer = useWorkflowStoreTwoExtraTwo(
    (state) => state.setTypeContainer,
  );
  const setSize = useWorkflowStoreTwoExtraTwo((state) => state.setSize);
  const setEntryPort = useWorkflowStoreTwoExtraTwo((state) => state.setEntryPort);

  // Setters para fotos de validación
  const setEmptyPanoramicValidationPhoto = useWorkflowStoreTwoExtraTwo(
    (state) => state.setEmptyPanoramicValidationPhoto,
  );
  const setEmptyStampNavieraValidationPhoto = useWorkflowStoreTwoExtraTwo(
    (state) => state.setEmptyStampNavieraValidationPhoto,
  );
  const setEmptyOtherStampValidationPhoto = useWorkflowStoreTwoExtraTwo(
    (state) => state.setEmptyOtherStampValidationPhoto,
  );
  const setEmptySatelliteLockValidationPhoto = useWorkflowStoreTwoExtraTwo(
    (state) => state.setEmptySatelliteLockValidationPhoto,
  );
  const setExitEngineryValidationPhoto1 = useWorkflowStoreTwoExtraTwo(
    (state) => state.setExitEngineryValidationPhoto1,
  );
  const setExitEngineryValidationPhoto2 = useWorkflowStoreTwoExtraTwo(
    (state) => state.setExitEngineryValidationPhoto2,
  );
  const setExitDoorValidationVideo = useWorkflowStoreTwoExtraTwo(
    (state) => state.setExitDoorValidationVideo,
  );
  const setExitEngineryValidationVideo = useWorkflowStoreTwoExtraTwo(
