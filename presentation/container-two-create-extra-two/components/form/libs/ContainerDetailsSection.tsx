...
const LabelSerial = () => {
  const labelSerial = useWorkflowStoreTwoExtraTwo((state) => state.labelSerial);
  const setLabelSerial = useWorkflowStoreTwoExtraTwo(
...
const ContainerOpened = () => {
  const openedWas = useWorkflowStoreTwoExtraTwo((state) => state.openedWas);
  const setOpenedWas = useWorkflowStoreTwoExtraTwo((state) => state.setOpenedWas);
  const openedBy = useWorkflowStoreTwoExtraTwo((state) => state.openedBy);
  const setOpenedBy = useWorkflowStoreTwoExtraTwo((state) => state.setOpenedBy);
...
const NavieraTypeSize = () => {
  const naviera = useWorkflowStoreTwoExtraTwo((state) => state.naviera);
  const setNaviera = useWorkflowStoreTwoExtraTwo((state) => state.setNaviera);
  const typeContainer = useWorkflowStoreTwoExtraTwo((state) => state.typeContainer);
  const setTypeContainer = useWorkflowStoreTwoExtraTwo(
    (state) => state.setTypeContainer,
  );
  const size = useWorkflowStoreTwoExtraTwo((state) => state.size);
...
const LocationDetails = () => {
  const city = useWorkflowStoreTwoExtraTwo((state) => state.city);
  const setCity = useWorkflowStoreTwoExtraTwo((state) => state.setCity);
  const address = useWorkflowStoreTwoExtraTwo((state) => state.address);
  const setAddress = useWorkflowStoreTwoExtraTwo((state) => state.setAddress);
  const typeReview = useWorkflowStoreTwoExtraTwo((state) => state.typeReview);
  const setTypeReview = useWorkflowStoreTwoExtraTwo((state) => state.setTypeReview);
  const storageName = useWorkflowStoreTwoExtraTwo((state) => state.storageName);
  const setStorageName = useWorkflowStoreTwoExtraTwo(
    (state) => state.setStorageName,
  );
  const entryPort = useWorkflowStoreTwoExtraTwo((state) => state.entryPort);
