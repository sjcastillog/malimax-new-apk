...
const ProductField = () => {
  const product = useWorkflowStoreTwoExtraTwo((state) => state.product);
  const setProduct = useWorkflowStoreTwoExtraTwo((state) => state.setProduct);
...
const PresentationField = () => {
  const presentation = useWorkflowStoreTwoExtraTwo(
    (state) => state.presentation,
  );
  const setPresentation = useWorkflowStoreTwoExtraTwo(
