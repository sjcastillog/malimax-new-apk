...
export const DriverSection = () => {
  const driverName = useWorkflowStoreTwoExtraTwo((state) => state.driverName);
  const setDriverName = useWorkflowStoreTwoExtraTwo((state) => state.setDriverName);
  const driverIdentification = useWorkflowStoreTwoExtraTwo(
  ...
  const plateVehicle = useWorkflowStoreTwoExtraTwo((state) => state.plateVehicle);
  const setPlateVehicle = useWorkflowStoreTwoExtraTwo(
    (state) => state.setPlateVehicle,
  );
  const companyTransport = useWorkflowStoreTwoExtraTwo(
