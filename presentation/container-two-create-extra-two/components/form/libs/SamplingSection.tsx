...
const NumberPalletField = () => {
  const numberPallet = useWorkflowStoreTwoExtraTwo(
    (state) => state.numberPallet,
  );
  const setNumberPallet = useWorkflowStoreTwoExtraTwo(
...
const NumberPresentationField = () => {
  const numberPresentation = useWorkflowStoreTwoExtraTwo(
    (state) => state.numberPresentation,
  );
  const setNumberPresentation = useWorkflowStoreTwoExtraTwo(
...
const NumberSamplingField = () => {
  const numberSampling = useWorkflowStoreTwoExtraTwo(
    (state) => state.numberSampling,
  );
  const setNumberSampling = useWorkflowStoreTwoExtraTwo(
