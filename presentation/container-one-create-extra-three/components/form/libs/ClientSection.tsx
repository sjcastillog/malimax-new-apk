...
export const ClientSection = () => {
  const client = useWorkflowStoreOneExtraThree((state) => state.client);
  const clientIdentification = useWorkflowStoreOneExtraThree(
    (state) => state.clientIdentification,
  );
  const setClient = useWorkflowStoreOneExtraThree((state) => state.setClient);
  const setClientId = useWorkflowStoreOneExtraThree(
    (state) => state.setClientId,
  );
  const setClientIdentification = useWorkflowStoreOneExtraThree(
