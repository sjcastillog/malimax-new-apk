...
const ExporterSupervisor = () => {
  const exporterSupervisor = useWorkflowStoreOneExtraThree(
    (state) => state.exporterSupervisor,
  );
  const exporterSupervisorIdentification = useWorkflowStoreOneExtraThree(
    (state) => state.exporterSupervisorIdentification,
  );
  const setExporterSupervisor = useWorkflowStoreOneExtraThree(
    (state) => state.setExporterSupervisor,
  );
  const setExporterSupervisorIdentification = useWorkflowStoreOneExtraThree(
...
const Associated = () => {
  const associated = useWorkflowStoreOneExtraThree((state) => state.associated);
  const associatedIdentification = useWorkflowStoreOneExtraThree(
    (state) => state.associatedIdentification,
  );
  const setAssociated = useWorkflowStoreOneExtraThree((state) => state.setAssociated);
  const setAssociatedIdentification = useWorkflowStoreOneExtraThree(
...
const Others = () => {
  const others = useWorkflowStoreOneExtraThree((state) => state.others);
  const othersIdentification = useWorkflowStoreOneExtraThree(
    (state) => state.othersIdentification,
  );
  const setOthers = useWorkflowStoreOneExtraThree((state) => state.setOthers);
  const setOthersIdentification = useWorkflowStoreOneExtraThree(
...
const Workplace = () => {
  const workplace = useWorkflowStoreOneExtraThree((state) => state.workplace);
  const setWorkplace = useWorkflowStoreOneExtraThree((state) => state.setWorkplace);
