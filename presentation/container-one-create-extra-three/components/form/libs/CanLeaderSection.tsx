...
const CanSelector = () => {
  ...
  const can = useWorkflowStoreOneExtraThree((state) => state.can);
  const setCan = useWorkflowStoreOneExtraThree((state) => state.setCan);
...
const LeaderSelector = () => {
  ...
  const leader = useWorkflowStoreOneExtraThree((state) => state.leader);
  const setLeader = useWorkflowStoreOneExtraThree((state) => state.setLeader);
  const [showModal, setShowModal] = useState(false);
