...
const LabelSerial = () => {
  const labelSerial = useWorkflowStoreOneExtraThree((state) => state.labelSerial);
  const setLabelSerial = useWorkflowStoreOneExtraThree(
...
const ContainerOpened = () => {
  const openedWas = useWorkflowStoreOneExtraThree((state) => state.openedWas);
  const setOpenedWas = useWorkflowStoreOneExtraThree((state) => state.setOpenedWas);
  const openedBy = useWorkflowStoreOneExtraThree((state) => state.openedBy);
  const setOpenedBy = useWorkflowStoreOneExtraThree((state) => state.setOpenedBy);
...
const NavieraTypeSize = () => {
  const naviera = useWorkflowStoreOneExtraThree((state) => state.naviera);
  const setNaviera = useWorkflowStoreOneExtraThree((state) => state.setNaviera);
  const typeContainer = useWorkflowStoreOneExtraThree((state) => state.typeContainer);
  const setTypeContainer = useWorkflowStoreOneExtraThree(
    (state) => state.setTypeContainer,
  );
  const size = useWorkflowStoreOneExtraThree((state) => state.size);
  const setSize = useWorkflowStoreOneExtraThree((state) => state.setSize);
...
const LocationDetails = () => {
  const city = useWorkflowStoreOneExtraThree((state) => state.city);
  const setCity = useWorkflowStoreOneExtraThree((state) => state.setCity);
  const address = useWorkflowStoreOneExtraThree((state) => state.address);
  const setAddress = useWorkflowStoreOneExtraThree((state) => state.setAddress);
  const typeReview = useWorkflowStoreOneExtraThree((state) => state.typeReview);
  const setTypeReview = useWorkflowStoreOneExtraThree((state) => state.setTypeReview);
  const storageName = useWorkflowStoreOneExtraThree((state) => state.storageName);
  const setStorageName = useWorkflowStoreOneExtraThree(
    (state) => state.setStorageName,
  );
  const entryPort = useWorkflowStoreOneExtraThree((state) => state.entryPort);
  const setEntryPort = useWorkflowStoreOneExtraThree((state) => state.setEntryPort);
