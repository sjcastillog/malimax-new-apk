...
const LabelSerial = () => {
  const labelSerial = useWorkflowStoreThreeExtraTwo((state) => state.labelSerial);
  const setLabelSerial = useWorkflowStoreThreeExtraTwo(
...
const ContainerOpened = () => {
  const openedWas = useWorkflowStoreThreeExtraTwo((state) => state.openedWas);
  const setOpenedWas = useWorkflowStoreThreeExtraTwo((state) => state.setOpenedWas);
  const openedBy = useWorkflowStoreThreeExtraTwo((state) => state.openedBy);
  const setOpenedBy = useWorkflowStoreThreeExtraTwo((state) => state.setOpenedBy);
...
const NavieraTypeSize = () => {
  const naviera = useWorkflowStoreThreeExtraTwo((state) => state.naviera);
  const setNaviera = useWorkflowStoreThreeExtraTwo((state) => state.setNaviera);
  const typeContainer = useWorkflowStoreThreeExtraTwo((state) => state.typeContainer);
  const setTypeContainer = useWorkflowStoreThreeExtraTwo(
    (state) => state.setTypeContainer,
  );
  const size = useWorkflowStoreThreeExtraTwo((state) => state.size);
  const setSize = useWorkflowStoreThreeExtraTwo((state) => state.setSize);
...
const LocationDetails = () => {
  const city = useWorkflowStoreThreeExtraTwo((state) => state.city);
  const setCity = useWorkflowStoreThreeExtraTwo((state) => state.setCity);
  const address = useWorkflowStoreThreeExtraTwo((state) => state.address);
  const setAddress = useWorkflowStoreThreeExtraTwo((state) => state.setAddress);
  const typeReview = useWorkflowStoreThreeExtraTwo((state) => state.typeReview);
  const setTypeReview = useWorkflowStoreThreeExtraTwo((state) => state.setTypeReview);
  const storageName = useWorkflowStoreThreeExtraTwo((state) => state.storageName);
  const setStorageName = useWorkflowStoreThreeExtraTwo(
    (state) => state.setStorageName,
  );
  const entryPort = useWorkflowStoreThreeExtraTwo((state) => state.entryPort);
  const setEntryPort = useWorkflowStoreThreeExtraTwo((state) => state.setEntryPort);
