...
export const ClientSection = () => {
  const client = useWorkflowStoreOneExtraOne((state) => state.client);
  const clientIdentification = useWorkflowStoreOneExtraOne(
    (state) => state.clientIdentification,
  );
  const setClient = useWorkflowStoreOneExtraOne((state) => state.setClient);
  const setClientId = useWorkflowStoreOneExtraOne((state) => state.setClientId);
  const setClientIdentification = useWorkflowStoreOneExtraOne(
