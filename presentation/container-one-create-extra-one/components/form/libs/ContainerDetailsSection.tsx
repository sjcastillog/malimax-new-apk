...
const LabelSerial = () => {
  const labelSerial = useWorkflowStoreOneExtraOne((state) => state.labelSerial);
  const setLabelSerial = useWorkflowStoreOneExtraOne(
...
const ContainerOpened = () => {
  const openedWas = useWorkflowStoreOneExtraOne((state) => state.openedWas);
  const setOpenedWas = useWorkflowStoreOneExtraOne((state) => state.setOpenedWas);
  const openedBy = useWorkflowStoreOneExtraOne((state) => state.openedBy);
  const setOpenedBy = useWorkflowStoreOneExtraOne((state) => state.setOpenedBy);
...
const NavieraTypeSize = () => {
  const naviera = useWorkflowStoreOneExtraOne((state) => state.naviera);
  const setNaviera = useWorkflowStoreOneExtraOne((state) => state.setNaviera);
  const typeContainer = useWorkflowStoreOneExtraOne((state) => state.typeContainer);
  const setTypeContainer = useWorkflowStoreOneExtraOne(
    (state) => state.setTypeContainer,
  );
  const size = useWorkflowStoreOneExtraOne((state) => state.size);
  const setSize = useWorkflowStoreOneExtraOne((state) => state.setSize);
...
const LocationDetails = () => {
  const city = useWorkflowStoreOneExtraOne((state) => state.city);
  const setCity = useWorkflowStoreOneExtraOne((state) => state.setCity);
  const address = useWorkflowStoreOneExtraOne((state) => state.address);
  const setAddress = useWorkflowStoreOneExtraOne((state) => state.setAddress);
  const typeReview = useWorkflowStoreOneExtraOne((state) => state.typeReview);
  const setTypeReview = useWorkflowStoreOneExtraOne((state) => state.setTypeReview);
  const storageName = useWorkflowStoreOneExtraOne((state) => state.storageName);
  const setStorageName = useWorkflowStoreOneExtraOne(
    (state) => state.setStorageName,
  );
  const entryPort = useWorkflowStoreOneExtraOne((state) => state.entryPort);
  const setEntryPort = useWorkflowStoreOneExtraOne((state) => state.setEntryPort);
