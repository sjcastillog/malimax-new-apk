...
export const InspectionSection = () => {
  const inspectedWas = useWorkflowStoreOneExtraOne((state) => state.inspectedWas);
  const setInspectedWas = useWorkflowStoreOneExtraOne(
    (state) => state.setInspectedWas,
  );
  const inspectedBy = useWorkflowStoreOneExtraOne((state) => state.inspectedBy);
  const setInspectedBy = useWorkflowStoreOneExtraOne(
