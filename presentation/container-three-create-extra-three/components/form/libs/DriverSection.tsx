...
export const DriverSection = () => {
  const driverName = useWorkflowStoreThreeExtraThree(
    (state) => state.driverName,
  );
  const setDriverName = useWorkflowStoreThreeExtraThree(
    (state) => state.setDriverName,
  );
  const driverIdentification = useWorkflowStoreThreeExtraThree(
    (state) => state.driverIdentification,
  );
  const setDriverIdentification = useWorkflowStoreThreeExtraThree(
    (state) => state.setDriverIdentification,
  );
  const plateVehicle = useWorkflowStoreThreeExtraThree(
    (state) => state.plateVehicle,
  );
  const setPlateVehicle = useWorkflowStoreThreeExtraThree(
    (state) => state.setPlateVehicle,
  );

  const companyTransport = useWorkflowStoreThreeExtraThree(
    (state) => state.companyTransport,
  );
  const setCompanyTransport = useWorkflowStoreThreeExtraThree(
