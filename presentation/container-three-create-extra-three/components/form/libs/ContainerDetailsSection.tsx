...
const LabelSerial = () => {
  const labelSerial = useWorkflowStoreThreeExtraThree((state) => state.labelSerial);
  const setLabelSerial = useWorkflowStoreThreeExtraThree(
...
const ContainerOpened = () => {
  const openedWas = useWorkflowStoreThreeExtraThree((state) => state.openedWas);
  const setOpenedWas = useWorkflowStoreThreeExtraThree((state) => state.setOpenedWas);
  const openedBy = useWorkflowStoreThreeExtraThree((state) => state.openedBy);
  const setOpenedBy = useWorkflowStoreThreeExtraThree((state) => state.setOpenedBy);
...
const NavieraTypeSize = () => {
  const naviera = useWorkflowStoreThreeExtraThree((state) => state.naviera);
  const setNaviera = useWorkflowStoreThreeExtraThree((state) => state.setNaviera);
  const typeContainer = useWorkflowStoreThreeExtraThree((state) => state.typeContainer);
  const setTypeContainer = useWorkflowStoreThreeExtraThree(
    (state) => state.setTypeContainer,
  );
  const size = useWorkflowStoreThreeExtraThree((state) => state.size);
  const setSize = useWorkflowStoreThreeExtraThree((state) => state.setSize);
...
const LocationDetails = () => {
  const city = useWorkflowStoreThreeExtraThree((state) => state.city);
  const setCity = useWorkflowStoreThreeExtraThree((state) => state.setCity);
  const address = useWorkflowStoreThreeExtraThree((state) => state.address);
  const setAddress = useWorkflowStoreThreeExtraThree((state) => state.setAddress);
  const typeReview = useWorkflowStoreThreeExtraThree((state) => state.typeReview);
  const setTypeReview = useWorkflowStoreThreeExtraThree((state) => state.setTypeReview);
  const storageName = useWorkflowStoreThreeExtraThree((state) => state.storageName);
  const setStorageName = useWorkflowStoreThreeExtraThree(
    (state) => state.setStorageName,
  );
  const entryPort = useWorkflowStoreThreeExtraThree((state) => state.entryPort);
  const setEntryPort = useWorkflowStoreThreeExtraThree((state) => state.setEntryPort);
